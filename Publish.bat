...
cd /d E:\Apps\AccountancyApp\accountancy-app-admin\accountancy-app-admin-ng16
...
cd /d E:\Apps\AccountancyApp\accountancy-app-admin\accountancy-app-admin-electron
